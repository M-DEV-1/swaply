/**
 * Swap Aggregator - Shared Types and Partner API Integrations
 * 
 * This module contains:
 * - Shared type definitions used across all routing implementations
 * - Token and configuration data
 * - Partner API integration stubs (Blockscout, Pyth, Avail)
 * 
 * All routing implementations (classic.ts, psb-dijkstra.ts) import from this module.
 */
